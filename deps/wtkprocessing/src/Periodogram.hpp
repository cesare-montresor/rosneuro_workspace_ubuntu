...
class Periodogram : public Method {

    public:
        Periodogram(void);

        virtual ~Periodogram(void);

        bool Setup(unsigned int wlength, unsigned int wtype, unsigned int fs, bool dolog);
