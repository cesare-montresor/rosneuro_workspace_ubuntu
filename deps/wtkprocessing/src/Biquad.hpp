...
public:
    ...
    void processBiquad(const Eigen::Ref<const Eigen::VectorXd>& in, Eigen::Ref<Eigen::VectorXd> out, const int stride, const int count, const vector <Biquad> coeffs);
    void processBiquadSG(const Eigen::Ref<const Eigen::VectorXd>& in, Eigen::Ref<Eigen::VectorXd> out, const int stride, const int count, const vector <Biquad> coeffs);
